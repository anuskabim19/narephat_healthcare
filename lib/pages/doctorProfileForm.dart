...
class DoctorProfileForm extends StatefulWidget {
  ...
  Doctor doctor;
  bool isEdit;
  DoctorProfileForm({required this.user,required  this.doctor, required this.isEdit});
  @override
...
class _DoctorProfileFormState extends State<DoctorProfileForm> {
  ...
  void initState() {
    ...
    if (widget.isEdit) {
      ...
      educationalQualificationController.text =
          widget.doctor.educationalQualification;
  ...
  void saveDoctorDetail() async {
    ...
    String educationalQualification =
        educationalQualificationController.text.trim();
    ...
    if (validClinicName &&
      ...
      Doctor doctor = Doctor(
          ...
          bio: bio,
          displayName: widget.isEdit
              ? widget.doctor.displayName
              : widget.user.displayName,
          email: widget.isEdit ? widget.doctor.email : widget.user.email,
          photoURL:
              widget.isEdit ? widget.doctor.photoURL : widget.user.photoURL, counter:0, name: '' );
      widget.isEdit
          ? await Backend().updateDoctorData(doctor)
          : await Backend().addDoctorInDataBase(doctor);
      Navigator.pop(context);
      Navigator.pop(context);
      Navigator.push(context,
          MaterialPageRoute(builder: (BuildContext context) => DoctorBottom()));
    }
  }
    ...
    return Container(
      child: Scaffold(
        appBar: AppBar(
          ...
          title:
              Text(widget.isEdit ? "Edit Your Profile" : "Create Your Profile"),
        ),
        body: isLoading
            ? Loading()
            : Container(
                      ...
                      children: [
                        ...
                        Center(
                          child: Container(
                            ...
                            child: CircleAvatar(
                              backgroundImage: NetworkImage(widget.isEdit
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              labelText: "Timing",
                              errorText:
                                  validTiming ? null : "Timing can't be empty"),
                        ),
                        SizedBox(height: 40),
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              labelText: "Address",
                              errorText:
                                  validAdd ? null : "Address can't be empty"),
                        ),
                        SizedBox(height: 40),
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              labelText: "Fee",
                              errorText:
                                  validFee ? null : "Fees can't be empty"),
                        ),
                        SizedBox(height: 40),
                        TextFormField(
